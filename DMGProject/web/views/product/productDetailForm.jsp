...
.productpage .tabcontent.current {
	display: block;
	/*border: 1px solid #8d8d8d;*/
	border-top: 0;
}

.productpage .tabcontent.current img {
	width: 100%;
}
...
.price .tabcontent1.current1 img {
	width: 100%;
}
...
<%@ include file="/views/common/header.jsp" %>
	...
	<section class="productbg">
		<div class="container">
			<div class="product_imgbox clearFix">
				<!-- Swiper -->
				...
				<div class="swiper-container gallery-top"
					...
					<div class="swiper-wrapper ">
						<div class="swiper-slide"
							style="background-image: url(/DMG/resources/images/background_.jpg)"></div>
						<div class="swiper-slide"
							style="background-image: url(/DMG/resources/images/background.jpg)"></div>
						<div class="swiper-slide"
							style="background-image: url(/DMG/resources/images/background_2.jpg)"></div>
						<!-- <div class="swiper-slide" style="background-image:url(/DMG/resources/images/background_.jpg)"></div>
      <div class="swiper-slide" style="background-image:url(/DMG/resources/images/background_.jpg)"></div>
      <div class="swiper-slide" style="background-image:url(/DMG/resources/images/background_.jpg)"></div>  -->
				...
				<div class="swiper-container gallery-thumbs"
					style="display: inline-block; position: absolute; top: 620px; height: 120px;">
					<div class="swiper-wrapper">
						<div class="swiper-slide"
							style="background-image: url(/DMG/resources/images/background_.jpg)"></div>
						<div class="swiper-slide"
    ...
    var galleryTop = new Swiper('.gallery-top', {
      ...
      thumbs: {
        swiper: galleryThumbs,
				...
				<div class="product_textbox clearFix">
					<p class="product_tit1">타이틀</p>
					<p class="product_tit2">서브타이틀</p>
					<p class="product_tit3">평점</p>
					<section class="price clearFix">

						<div id="tab3" class="tabcontent1 current1 clearFix">
							<p class="price_p">
								가격 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<span class="price_price"><%=product.getPprice() %></span>&nbsp&nbsp원
							</p>

						</div>
					</section>
					<div class="product_textbox clearFix">
						<p class="order1">장바구니</p>
						<button class="order2" onclick="location.href='buy.jsp'">바로구매</button>
					</div>
				</div>
			</div>
		</div>
...
<!-- 유사상품 -->
	<section class="container">
		...
		<div class="Similar-products">
			...
			<div class="ui special cards" style="margin: 10px; width: 1200px;">
				<div class="card">
					<div class="blurring dimmable image">
						...
						<img src="/DMG/resources/images/background_.jpg">
					</div>
					<div class="content">
						<a class="header">상품명</a>
						<div class="meta">
							<span class="date">가격</span>
						</div>
						<div class="extra content">평점</div>
					</div>
				...
				<div class="card">
					<div class="blurring dimmable image">
						...
						<img src="/DMG/resources/images/background_2.jpg">
					</div>
					<div class="content">
...
<div class="ui pointing secondary menu">
  <a class="item active" data-tab="first" style="padding: 20px 124px;">제품상세</a>
  <a class="item" data-tab="second" style="padding: 20px 124px;">상품명</a>
  <a class="item" data-tab="third" style="padding: 20px 124px;">상품문의</a>
    <a class="item" data-tab="fourth" style="padding: 20px 124px;">배송문의</a>
...
<section class="container">
 ...
 <div class="ui styled accordion container" style="width:100%;">
