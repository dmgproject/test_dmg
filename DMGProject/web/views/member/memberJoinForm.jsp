...
#idCheck, #ckZip, #goMain, #joinBtn, #NickNameCheck {
	...
	<div class="outer">
		...
		<form id="joinForm"
			...
			<table align="center">
				...
				<tr>
					<td>* 닉네임</td>
					<td><input type="text" maxlength="10" id="userNickName"
						name="userNickName" required="required"></td>
					<td width="200px"><div id="NickNameCheck">중복확인</div></td>
				</tr>
				<tr>
					<td>성별</td>
				...
				<tr>
					...
					<td><input type="number" name="age" min="10" max="100"
						value="10" style="width: 140px;">&nbsp;세</td>
					<td></td>
				</tr>
				<tr>
					<td>연락처</td>
