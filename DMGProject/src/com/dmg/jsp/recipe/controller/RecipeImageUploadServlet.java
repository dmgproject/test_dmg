...
/**
 * Servlet implementation class RecipeImageUploadServlet
 */
@WebServlet("/rImage.re")
public class RecipeImageUploadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecipeImageUploadServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 업로드할 파일의 용량 제한 : 10Mbyte로 제한한다면
				...
				out.print("http://localhost:8088/DMG/resources/recipeUpload/" + fileName);
				out.flush();
				out.close();
	}
