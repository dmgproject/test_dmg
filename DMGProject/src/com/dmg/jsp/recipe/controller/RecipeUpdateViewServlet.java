...
/**
 * Servlet implementation class RecipeUpdateViewServlet
 */
@WebServlet("/rUpdateView.re")
public class RecipeUpdateViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecipeUpdateViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (rcp != null && rcp.get("attachment") != null) {
			...
			page = "views/thumbnail/reUpdateView.jsp";
