...
<%@ include file="../common/header.jsp" %>
	<div class="outer">
		...
		<form id="updateForm" action="/DMG/mUpdate.me" method="post">
			...
			<table align="center">
				...
				<tr>
					<td>* 닉네임</td>
					<td style="color:white; text-align: left; padding-left: 20px;"><%= m.getUserNickName() %></td>
					<td width="200px"></td>
				</tr>
				<tr>
					<td>성별 </td>
				...
				<tr>
					<td>이메일 </td>
					<td><input type="email" id="email" name="email" value="<%= m.getEmail() %>"></td>
					<td></td>
				</tr>
				<tr>
					<td>우편번호</td>
			...
			<script>
				...
				function deleteMember() {
					location.href = "/DMG/mDelete.me?mid=<%=m.getUserId()%>";
				}
